                    ...
                    <View style={styles.body}>
                        <View style={{borderBottomWidth: 0.6, borderBottomColor: '#35383930', height: 80, alignItems: 'center', justifyContent: 'center'}}>
                            <TouchableOpacity onPress={ () => this.props.navigation.navigate('Profile') } activeOpacity={0.8}>
                                <Icon type="MaterialIcons" name="settings" style={{fontSize:35 , color: 'grey'}} />
                            </TouchableOpacity>
                            <Text style={{ color: 'grey', fontSize: 12, fontWeight: 'bold', alignItems: 'center'}}>Edit profile</Text>
                        </View>
